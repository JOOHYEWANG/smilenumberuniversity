<template>
  <div class="grid-container-2">
    <div v-for="i in 24" :key="i" class="grid-item" @mouseenter="enlargeImage(i)" @mouseleave="resetImage(i)">
      <img :src="getImageUrl(i)" :alt="'CargoTruck' + i" :class="'image-2-' + i" @click="goToCargoTruck(i)" />
      <p class="image-label">{{ 'CargoTruck' + i }}</p>
    </div>
  </div>
</template>
