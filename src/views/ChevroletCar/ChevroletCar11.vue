<template>
  ...
  <div class="car-details">
    ...
    <div class="another-smile-car">ANOTHER CHEVROLET CAR</div>
  ...
  data() {
    return {
      car: {
        ...
        model: "SmileNumber's Chevrolet Car",
        year: 2024,
        bodyType: 'Sedan',
        engineType: 'Electric',
      ...
      carParts: [
        { name: 'main View', src: require('@/assets/ChevroletCar11.png') },
      ...
      mainImage: require('@/assets/ChevroletCar11.png'),
      cars: [],
