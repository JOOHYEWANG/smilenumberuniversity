...
<br><br>
  ...
  <div>
    <div class="SunFlowercontainer">
      ...
      4 하늘에 올라갔다가 내려온 사람이 누구며, 바람을 자기 손에 움켜 쥐고 있는 사람이 누구냐?
        물을 그 옷자락으로 싸고 있는 사람이 누구며 땅의 모든 경계선을 그은 사람이 누구인가?
        그 사람의 이름은 무엇인지, 그의 아들의 이름은 무엇인지, 정말 네가 아느냐?
      5 하나님의 말씀은 모두 순결하며, 그분은 그를 의지하는 사람의 방패가 되신다.
      6 그 말씀에 아무것도 더하지 말아라. 그렇지 않으면 그분이 너를 책망하시고, 너는 거짓말을 하는 사람이 될 것이다.
        , 헌신의 잠언:  7 주님께 두 가지 간청을 드리니, 제가 죽기 전에 그것을 이루어 주십시오.
    ...
    <div v-for="index in 3" :key="index" class="sunflower" ref="sunflowerRefs">
      <div class="petals">
