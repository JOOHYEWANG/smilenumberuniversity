<template>
  ...
  <div class="car-details">
    ...
    <div class="another-smile-car">ANOTHER SAMSUNG CAR</div>
  ...
  data() {
    return {
      car: {
        ...
        model: "SmileNumber's Samsung Car",
        year: 2024,
        bodyType: 'Sedan',
        engineType: 'Electric',
      ...
      carParts: [
        { name: 'main View', src: require('@/assets/SamsungCar11.png') },
      ...
      mainImage: require('@/assets/SamsungCar11.png'),
      cars: [],
