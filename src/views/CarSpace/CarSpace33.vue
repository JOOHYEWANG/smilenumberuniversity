<template>
  ...
  <div class="car-details">
    ...
    <div class="another-smile-car">ANOTHER MONKEY CAR</div>
...
export default {
  ...
  data() {
    return {
      ...
      carParts: [
        { name: 'main View', src: require('@/assets/CarSpace33.png') },
      ...
      mainImage: require('@/assets/CarSpace33.png'),
      cars: [],
