...
<div class="car-details">
   ...
   <div class="another-smile-car">ANOTHER MONSTER TRUCK</div>
 ...
 data() {
   return {
     car: {
       ...
       model: "SmileNumber's Monkey Car",
       year: 2024,
       bodyType: 'Sedan',
       engineType: 'Electric',
     ...
     carParts: [
       { name: 'main View', src: require('@/assets/CargoTruck27.png') },
     ...
     mainImage: require('@/assets/CargoTruck27.png'), // 초기 메인 이미지
     cars: [
...
.car-grid-container {
position: relative;
margin-top: -2325px; /* 원하는 만큼 요소를 위쪽으로 이동 */
