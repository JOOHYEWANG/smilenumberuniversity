<template>
  ...
  <div class="car-details">
    ...
    <div class="another-smile-car">ANOTHER SMILE TRUCK</div>
  ...
  data() {
    return {
      car: {
        ...
        model: "SmileNumber's Smile Truck",
        year: 2024,
        bodyType: 'Sedan',
        engineType: 'Electric',
        ...
        safetyFeatures: 'Smile, Love, Airbags, Monkey, ABS, ESC',
        price: 35000,
      },
      carParts: [
        { name: 'main View', src: require('@/assets/SmileMobile15.png') },
      ...
      mainImage: require('@/assets/SmileMobile15.png'),
      cars: [],
