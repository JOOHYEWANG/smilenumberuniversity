...
<div class="car-details">
   ...
   <div class="another-smile-car">ANOTHER HYUNDAI CAR</div>
...
export default {
 name: 'CarDetails',
 components: {
   CarSpaceCarGridHyundai, // 컴포넌트 등록
   RainbowMenu,
 },
 data() {
   return {
     car: {
       ...
       model: "SmileNumber's HYUNDAI Car",
       year: 2024,
       bodyType: 'Sedan',
       engineType: 'Electric',
     ...
     carParts: [
       { name: 'main View', src: require('@/assets/HyundaiCar16.png') },
     ...
     mainImage: require('@/assets/HyundaiCar16.png'), // 초기 메인 이미지
     cars: [
...
.car-grid-container {
position: relative;
margin-top: -2300px; /* 원하는 만큼 요소를 위쪽으로 이동 */
