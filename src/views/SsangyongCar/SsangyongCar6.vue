<template>
  ...
  <div class="car-details">
    ...
    <div class="another-smile-car">ANOTHER SSANGYONG CAR</div>
  ...
  data() {
    return {
      car: {
        ...
        model: "SmileNumber's Ssangyong Car",
        year: 2024,
        bodyType: 'Sedan',
        engineType: 'Electric',
      ...
      carParts: [
        { name: 'main View', src: require('@/assets/SsangyongCar6.png') },
      ...
      mainImage: require('@/assets/SsangyongCar6.png'),
      cars: [],
