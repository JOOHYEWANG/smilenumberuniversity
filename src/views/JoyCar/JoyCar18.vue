<template>
  ...
  <div class="car-details">
    ...
    <div class="another-smile-car">ANOTHER JOY MOBILE</div>
  ...
  data() {
    return {
      car: {
        ...
        model: "SmileNumber's Joy Mobile",
        year: 2024,
        bodyType: 'Sedan',
        engineType: 'Electric',
      ...
      carParts: [
        { name: 'main View', src: require('@/assets/JoyCar18.png') },
      ...
      mainImage: require('@/assets/JoyCar18.png'),
      cars: [],
